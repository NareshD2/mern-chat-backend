...
const Sidebar = ({ setSelectedGroup }) => {
  ...
  return (
    ...
    >
      ...
      >
        <Flex align="center">
          <Icon as={FiUsers} fontSize="24px" color="green.500" mr={2} />
        ...
        <VStack spacing={3} align="stretch">
          {groups.map((group) => (
            <Box
              ...
              cursor="pointer"
              borderRadius="lg"
              bg={userGroups.includes(group?._id) ? "green.50" : "gray.50"}
              borderWidth="1px"
              borderColor={
                userGroups.includes(group?._id) ? "green.200" : "gray.200"
              }
              transition="all 0.2s"
              _hover={{
            ...
            >
              <Flex justify="space-between" align="center">
                ...
                <Button
                  size="sm"
                  colorScheme={
                    userGroups?.includes(group?._id) ? "red" : "green"
                  }
                  ...
                  _hover={{
                    ...
                    bg: group.isJoined ? "red.50" : "green.600",
                  }}
                  transition="all 0.2s"
                >
                  {userGroups.includes(group?._id) ? (
